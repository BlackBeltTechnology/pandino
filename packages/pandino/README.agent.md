# README.agent.md — digest of `packages/pandino/README.md`
...
- **Quick start**: bootstrap framework → imperative service register/consume → decorator-based component.
- **Service properties & LDAP filters**.
