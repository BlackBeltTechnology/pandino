...
export const CONFIG_ADMIN_INTERFACE_KEY = '@pandino/configuration-management/ConfigurationAdmin';
export const MANAGED_SERVICE_INTERFACE_KEY = '@pandino/configuration-management/ManagedService';
export const CONFIGURATION_LISTENER_INTERFACE_KEY = '@pandino/configuration-management/ConfigurationListener';
