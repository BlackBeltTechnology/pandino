...
describe('BundleEventAdapter', () => {
  ...
  it.each`
    ...
    ${'INSTALLED'}   | ${'@pandino/pandino-event-admin/BundleEvent/INSTALLED'}
    ${'STARTED'}     | ${'@pandino/pandino-event-admin/BundleEvent/STARTED'}
    ${'STOPPED'}     | ${'@pandino/pandino-event-admin/BundleEvent/STOPPED'}
    ${'UPDATED'}     | ${'@pandino/pandino-event-admin/BundleEvent/UPDATED'}
    ${'UNINSTALLED'} | ${'@pandino/pandino-event-admin/BundleEvent/UNINSTALLED'}
    ${'RESOLVED'}    | ${'@pandino/pandino-event-admin/BundleEvent/RESOLVED'}
    ${'UNRESOLVED'}  | ${'@pandino/pandino-event-admin/BundleEvent/UNRESOLVED'}
