...
import { EVENT, SERVICE, SERVICE_ID, SERVICE_OBJECTCLASS, SERVICE_PID } from '@pandino/pandino-event-api';
...
describe('ServiceEventAdapter', () => {
  ...
  it.each`
    ...
    ${'REGISTERED'}    | ${undefined}        | ${'@pandino/pandino-event-admin/ServiceEvent/REGISTERED'}
    ${'REGISTERED'}    | ${'@scope/svc/sv1'} | ${'@pandino/pandino-event-admin/ServiceEvent/REGISTERED'}
    ${'MODIFIED'}      | ${undefined}        | ${'@pandino/pandino-event-admin/ServiceEvent/MODIFIED'}
    ${'UNREGISTERING'} | ${undefined}        | ${'@pandino/pandino-event-admin/ServiceEvent/UNREGISTERING'}
