...
cp ../../packages/@pandino/pandino-configuration-management/dist/esm/pandino-configuration-management-manifest.json dist/pandino-configuration-management-manifest.json
cp ../../packages/@pandino/pandino-configuration-management/dist/esm/pandino-configuration-management.mjs dist/pandino-configuration-management.mjs
