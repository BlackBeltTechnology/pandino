---
title: Whiteboard Pattern
description: The Whiteboard Pattern in Pandino - loose coupling through service registration, discovery, and event handling.
---
...
Pandino provides a robust implementation of the Whiteboard Pattern through its service registry.
...
- [Extender Pattern](/patterns/extender-pattern) -- how SCR monitors bundles
- [Events concept](/concepts/events) -- EventAdmin and topic-based messaging
- [Services concept](/concepts/services) -- service registry details
