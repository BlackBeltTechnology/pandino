---
title: Decorator Extenders
description: Build small extenders that react to component decorators and wire your own features without re-implementing SCR.
---
...
- [Extender Pattern](/patterns/extender-pattern) -- conceptual overview of SCR as an extender
- [Whiteboard Pattern](/patterns/whiteboard-pattern) -- EventAdmin and event handling
- [Events concept](/concepts/events) -- EventAdmin topic-based messaging
- [Decorators guide](/guide/decorators) -- decorator usage
