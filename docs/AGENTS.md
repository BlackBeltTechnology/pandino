...
Pattern and how-to guides for Pandino's OSGi-inspired mechanisms.

| `docs/creating-decorator-extenders.md` | How-to: build small extenders that react to component decorators to wire custom features (UI, views, routing) without re-implementing SCR. |
| `docs/extender-pattern.md` | Extender pattern explained: an extender bundle monitors other bundles and provides functionality based on their metadata. |
